...
void                      soup_set_kcookies_flag                      (int kcookies_flag);
int                       soup_get_kcookies_flag                      (void);

int soup_cookie_hash(char* request_param);
void soup_cookie_jar_add_cookie_with_flag (SoupCookieJar *jar, SoupCookie *cookie, gboolean isItInvalidationCookie);
