...
{
#ifdef PRINT_DBG_MSG	
	fprintf(stderr, "## soup_connection_connect_async\n");
#endif
	guint status;
...
#ifdef PRINT_DBG_MSG	
	fprintf(stderr, "## soup_connection_connect_async : synchronous socket connection is used\n");
#endif
	...
	// DON:INFO: this is the entry point from the webkit to libsoup.
	/*
	  ORIGINAL CODE
...
{
	//printf("## soup_connection_connect_sync\n");
